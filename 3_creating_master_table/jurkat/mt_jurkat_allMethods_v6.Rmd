...
create the master table for jurkat data.
...
# VCF files
METHOD_VCF_FILES <- c(
  "~/project_2021/datasets/gloria_data/analysis/dv_calls/noMarkDuplicate/dv_alone/deepvariant_calls_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/dv_calls/noMarkDuplicate/no_flagCorrection/deepvariant_calls_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/dv_calls/noMarkDuplicate/deepvariant_calls_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/clair3_isoSeq/alone/pileup_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/clair3_isoSeq/sncr/pileup_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/clair3_isoSeq/sncr_fc/pileup_pass.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/clair3_isoSeq/mix/pileup_pass_mix_nodup.recode.vcf.gz",
  "~/project_2021/datasets/gloria_data/analysis/gatk_calls_isoSeq/noMarkDuplicate/isoSeq_jurkat.recal_pass.vcf.gz",
  "/home/vbarbo/project_2021/datasets/gloria_data/analysis/nanocaller_from_sherborne/yes_sncr_no_fc/variant_calls.final.vcf.gz"
)
# BAM of the data
METHOD_BAM_FILE <- "/home/vbarbo/project_2021/datasets/gloria_data/analysis/dv_calls/aln.bam"


### ground-truth
# name
TRUTH_NAME <- "jurkat_dna_merged"
# name of the dataset used to generate the ground-truth
TRUTH_DATASET_NAME <- "shortRead"
# VCF file
TRUTH_VCF_FILE <- "/home/vbarbo/project_2021/datasets/gloria_data/analysis/truth_merged_bams/primary/jurkat150bp.recal_pass.vcf"
...
load("/home/vbarbo/load_later/tr_dna_merged_p_cover.RData")
truth_coverage <- tr_dna_merged_p_cover
```
...
```{r}
### truth
dat <- is_indel_method(dat, "jurkat_dna_merged")

### dv
dat <- is_indel_method(dat, "jurkat_dna_merged", "dv")

### dv_s
dat <- is_indel_method(dat, "jurkat_dna_merged", "dv_s")

### dv_s_fc
dat <- is_indel_method(dat, "jurkat_dna_merged", "dv_s_fc")

### c3
dat <- is_indel_method(dat, "jurkat_dna_merged", "c3")

### c3_s
dat <- is_indel_method(dat, "jurkat_dna_merged", "c3_s")

### c3_s_fc
dat <- is_indel_method(dat, "jurkat_dna_merged", "c3_s_fc")

### c3_mix
dat <- is_indel_method(dat, "jurkat_dna_merged", "c3_mix")

### gatk_s
dat <- is_indel_method(dat, "jurkat_dna_merged", "gatk_s")

### nc_s
dat <- is_indel_method(dat, "jurkat_dna_merged", "nc_s")
```
...
```{r}
dat <- add_format_tag_from_vcf(dat, "jurkat_dna_merged", "GT", TRUTH_VCF_FILE)
...
k <- is.na( dat[ ,c("gt_jurkat_dna_merged", "gt_dv_s_fc", "gt_c3_mix", "gt_gatk_s", "gt_nc_s") ] )
dat[ ,c("gt_jurkat_dna_merged", "gt_dv_s_fc", "gt_c3_mix", "gt_gatk_s", "gt_nc_s") ] [k] <- "0/0"
```
...
save(mt_jurkat_allMethods_notFiltered,
     file="/home/vbarbo/project_2021/projects/iso-seq_variant_calling/scripts_for_all_analyses_in_the_paper/3_creating_master_table/jurkat/mt_jurkat_allMethods_notFiltered_v6.RData",
     compress="xz")
```
...
k <- !( dat1$variantDensity_jurkatDnaMerged > 3 )
dat1 <- dat1[k,]
dim(dat1)
...
save(mt_jurkat_allMethods_filtered,
     file="/home/vbarbo/project_2021/projects/iso-seq_variant_calling/scripts_for_all_analyses_in_the_paper/3_creating_master_table/jurkat/mt_jurkat_allMethods_filtered_v6.RData",
     compress="xz")
```
