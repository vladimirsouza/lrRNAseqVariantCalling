...
k <- paste0("variantDensity_", TRUTH_NAME)
k <- !( dat1[,k] > 3 )
k1 <- variant_density_column <- paste( c("variantDensity", to_lower_camel_case(METHOD_NAMES)), collapse = "_" )
k1 <- !( dat1[,k1] > 3 )
k <- k | k1
dat1 <- dat1[k,]
dim(dat1)
...
save(mt_wtc11_allMethods_filtered_filterVariantDensityIsoSeqAllMethods,
     file="/home/vbarbo/project_2021/paper_analysis/extra_files/master_tables/mt_wtc11_allMethods_filtered_v7_filterVariantDensityIsoSeqAllMethods.RData",
     compress="xz")
```
