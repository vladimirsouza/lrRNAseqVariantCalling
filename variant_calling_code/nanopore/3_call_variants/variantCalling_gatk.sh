...
# wtc-11
# nanopore rna-seq raw sequencding data
# read group added
...
INPUT_BAM=/home/vbarbo/project_2021/paper_analysis/secondary_analyses/nanopore/files/ENCFF961HLO/data_manipulation/aln_sncr.bam
OUTPUT_DIR=/home/vbarbo/project_2021/paper_analysis/secondary_analyses/nanopore/files/ENCFF961HLO/variant_calling_from_nanopore/gatk
SAMPLE=nanopore_wtc11
THREADS=30
PATH_TO_REPO_TOOLS=/home/vbarbo/project_2021/projects/lrRNAseqVariantCalling/tools
...
### SplitNCigarReads may generate reads with faulty cigar strings, i.e. consecutive 'S's, e.g. 100M10S20S. 
### This makes Picard's AddOrReplaceReadGroups fail. Fix these faults.
Rscript ${PATH_TO_REPO_TOOLS}/fixSoftClippingOfBAM.r \
  ${INPUT_BAM} \
  ${OUTPUT_DIR}/aln_sncr_fixedCigar.bam
...
java -XX:ParallelGCThreads=$THREADS -jar /home/vbarbo/programs/picard/build/libs/picard.jar AddOrReplaceReadGroups \
  -I ${OUTPUT_DIR}/aln_sncr_fixedCigar.bam \
  -O $OUTPUT_DIR/aln_sncr_fixedCigar_rg.bam \
  -SO coordinate \
  -RGID group1 \
  -RGSM sample1 \
  -RGPL ont \
...
samtools index -@ $THREADS $OUTPUT_DIR/aln_sncr_fixedCigar_rg.bam
...
do
  gatk --java-options "-Xmx4G" BaseRecalibrator \
    -R $REF \
    -I $OUTPUT_DIR/aln_sncr_fixedCigar_rg.bam \
