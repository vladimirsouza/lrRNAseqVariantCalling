...
# In this script we call variants from Illumina short reads. We use the same data used to identify allele specific expressed (ASE) genes in WTC-11.
...
### inputs
SNCR_BAM=/home/vbarbo/project_2021/paper_analysis/secondary_analyses/short_reads/files/data_manipulation/GSE175048_Aligned.sortedByCoord.out_primary_readGroupAddedSameOrder_sncr.bam
REF=/home/vbarbo/project_2021/paper_analysis/reference/genome/GRCh38.p13_all_chr.fasta
OUTPUT_DIR=/home/vbarbo/project_2021/paper_analysis/secondary_analyses/short_reads/files/variant_calling_from_short_reads/gatk
SAMPLE=short_reads_wtc11
THREADS=30
